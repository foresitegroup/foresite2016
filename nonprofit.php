...
<div id="industry-banner">
  <div class="site-width">
    <h1>WE ARE SHAPED TO SERVE</h1><br>

    <!-- <h2>MANUFACTURERS &amp; DISTRIBUTORS</h2> -->

    <h3>OUR COMPACT SIZE AND OUTSIZED TALENT MAKE US IDEAL FOR YOUR BUDGET CAUTIOUS PROJECT</h3>

    With over 40 years of combined experience in website design and development, as well as social media, out  bound and online advertising campaigns, we are a perfect fit for nonprofit and charitable organizations. We recognize that every NPO has their own needs and goals. As a team, Foresite takes the time to listen and understand your area of expertise, then guide and work directly with you through a process unique to your story.
  </div>
</div>
...
<div id="industry-work" class="cf">
  <div class="tile tile3x1" style="background-image: url(images/project-kubly.jpg);">
    <div class="tile-link">
  ...
  <div class="tile tile3x1" style="background-image: url(images/project-edh.jpg);">
    <div class="tile-link">
      <div class="tile-hover-content">
        <h2>EVERY DAY HOPE</h2>

        <a href="https://everydayhope.org">CLIENT SITE</a><br>
        <a href="edh.php">OUR IMPACT</a>
      </div>
    </div>
  </div>
  ...
  <div class="tile tile3x1" style="background-image: url(images/project-louies.jpg);">
    <div class="tile-link">
      <div class="tile-hover-content">
        ...
        <a href="http://louieslast.org">CLIENT SITE</a><br>
        <a href="louies.php">OUR IMPACT</a>
      </div>
    </div>
  </div>

  <div class="tile tile3x1" style="background-image: url(images/project-wpf.jpg);">
    <div class="tile-link">
      <div class="tile-hover-content">
  ...
  <div class="tile tile3x1" style="background-image: url(images/project-bublr.jpg);">
    <div class="tile-link">
      <div class="tile-hover-content">
        <h2>BUBLR BIKES</h2>

        <a href=https://bublrbikes.org">CLIENT SITE</a><br>
        <a href="bublr.php">OUR IMPACT</a>
      </div>
    </div>
  </div>

  <div class="tile tile3x1" style="background-image: url(images/project-lonergan-resource.jpg);">
    <div class="tile-link">
      <div class="tile-hover-content">
        <h2>LONERGAN RESOURCE</h2>

        <a href="https://lonerganresource.com">CLIENT SITE</a><br>
      </div>
    </div>
  </div>
</div>
